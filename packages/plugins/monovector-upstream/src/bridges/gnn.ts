 ...
 *
 * Bridge to monovector-gnn-wasm for graph-based learning and inference.
 */
...
export class GnnBridge implements WasmBridge<GnnModule> {
  readonly name = 'monovector-gnn-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@monoes/gnn-wasm').catch(() => null);
