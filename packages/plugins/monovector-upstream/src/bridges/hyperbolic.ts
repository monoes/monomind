 ...
 *
 * Bridge to monovector-hyperbolic-hnsw-wasm for hierarchical data representation
...
export class HyperbolicBridge implements WasmBridge<HyperbolicModule> {
  readonly name = 'monovector-hyperbolic-hnsw-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@monoes/hyperbolic-hnsw-wasm').catch(() => null);
