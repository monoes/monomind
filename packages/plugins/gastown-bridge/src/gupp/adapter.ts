 ...
 *
 * Bridge between GUPP work tracking and Monomind session management.
...
/**
 * Session manager interface (Monomind compatible)
 */
...
/**
 * GUPP Adapter - Bridge between Gas Town work tracking and Monomind sessions
 *
