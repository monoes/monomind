 ...
 *
 * Bridge between GUPP work tracking and Monobrain session management.
...
/**
 * Session manager interface (Monobrain compatible)
 */
...
/**
 * GUPP Adapter - Bridge between Gas Town work tracking and Monobrain sessions
 *
