 ...
 *
 * @module v1/plugins/agentic-qe/interfaces
 */
...
/**
 * Memory bridge interface for V1 memory integration
 */
...
/**
 * Security bridge interface for V1 security integration
 */
...
/**
 * Core bridge interface for V1 core services
 */
...
/**
 * Hive bridge interface for V1 Hive Mind coordination
 */
