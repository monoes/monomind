 ...
 *
 * @module v1/plugins/agentic-qe/bridges/QECoreBridge
 */
 ...
 *
 * Bridges agentic-qe core needs to V1's core services.
...
export class QECoreBridge implements IQECoreBridge {
  ...
  /**
   * Spawn a test execution agent via V1 Core
   */
  ...
  /**
   * Create a test execution task via V1 Task Service
   */
