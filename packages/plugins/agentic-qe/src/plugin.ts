 ...
 *
 * @module v1/plugins/agentic-qe/plugin
 * @version 3.2.3
 */
...
/**
 * Plugin interface for V1 plugin system
 */
interface IPlugin {
...
/**
 * Plugin context with V1 services
 */
...
/**
 * Maps QE bounded contexts to V1 domains
 */
class ContextMapper implements IContextMapper {
    ...
    const mappingData: ContextMapping[] = [
      {
        ...
        memoryNamespace: 'aqe/v1/test-patterns',
        securityLevel: 'medium',
      },
      {
        qeContext: 'test-execution',
        domains: ['Core', 'Coordination'],
        agents: [
      ...
      },
      {
        ...
        memoryNamespace: 'aqe/v1/coverage-data',
        securityLevel: 'low',
      },
      {
      ...
      },
      {
        ...
        memoryNamespace: 'aqe/v1/defect-patterns',
        securityLevel: 'low',
      },
      {
      ...
      },
      {
        ...
        memoryNamespace: 'aqe/v1/security-findings',
      ...
      },
      {
        ...
        memoryNamespace: 'aqe/v1/visual-baselines',
        securityLevel: 'medium',
      },
      {
        ...
        memoryNamespace: 'aqe/v1/chaos-experiments',
        securityLevel: 'critical',
      },
      {
        qeContext: 'learning-optimization',
        domains: ['Memory', 'Integration'],
        agents: [
          'cross-domain-learner', 'pattern-optimizer',
        ],
        memoryNamespace: 'aqe/v1/learning-trajectories',
        securityLevel: 'low',
      },
    ];
  ...
  getMemoryNamespace(context: BoundedContext): string {
    return this.mappings.get(context)?.memoryNamespace ?? 'aqe/v1/default';
  }
}
  ...
  async shutdown(): Promise<void> {
    ...
    try {
      ...
      if (memoryService) {
        ...
        const tempNamespaces = ['aqe/v1/coverage-data'];
