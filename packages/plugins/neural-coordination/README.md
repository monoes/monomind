...
[![npm version](https://img.shields.io/npm/v/@monobrain/plugin-neural-coordination.svg)](https://www.npmjs.com/package/@monobrain/plugin-neural-coordination)
[![license](https://img.shields.io/npm/l/@monobrain/plugin-neural-coordination.svg)](https://github.com/nokhodian/monobrain/blob/main/LICENSE)
[![downloads](https://img.shields.io/npm/dm/@monobrain/plugin-neural-coordination.svg)](https://www.npmjs.com/package/@monobrain/plugin-neural-coordination)
...
```bash
npx monobrain plugins install --name @monobrain/plugin-neural-coordination
```

## Quick Start

```typescript
import { NeuralCoordinationPlugin } from '@monobrain/plugin-neural-coordination';
...
|--------|-------------|---------|
| [@monobrain/plugin-cognitive-kernel](https://www.npmjs.com/package/@monobrain/plugin-cognitive-kernel) | Cognitive augmentation with working memory | Enhances individual agent reasoning within coordinated swarms |
| [@monobrain/plugin-quantum-optimizer](https://www.npmjs.com/package/@monobrain/plugin-quantum-optimizer) | Quantum-inspired optimization | Optimizes task allocation and resource scheduling across agents |
| [@monobrain/plugin-hyperbolic-reasoning](https://www.npmjs.com/package/@monobrain/plugin-hyperbolic-reasoning) | Hierarchical reasoning | Enables hierarchical agent organization and taxonomic coordination |
