 ...
 * Run: npx tsx --test v1/__tests__/appliance/gguf-engine.test.ts
 */
...
/**
 * Build a minimal valid GGUF v1 binary buffer with the given KV pairs.
 */
...
describe('parseGgufHeader', () => {
  it('parses a minimal GGUF v1 file with string KV entries', async () => {
