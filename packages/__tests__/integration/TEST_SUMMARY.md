...
npm run test:coverage:integration
# Open v1/__tests__/coverage/index.html
...
- name: Upload Coverage
  ...
  with:
    files: ./v1/__tests__/coverage/lcov.info
```
...
- **Full Documentation**: `/v1/__tests__/integration/README.md`
- **Quick Start**: `/v1/__tests__/integration/QUICK_START.md`
- **Architecture**: `/v1/docs/architecture/`
...
The V1 integration test suite provides comprehensive coverage of all major architectural components and their interactions. Tests are fast, isolated, deterministic, and well-documented. The suite is ready for CI/CD integration and supports the development workflow with watch mode and debugging capabilities.
