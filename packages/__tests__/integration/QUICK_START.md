...
This directory contains 75 comprehensive integration tests across 5 test files covering all major V1 modules and their interactions.
...
Import from `/v1/__tests__/integration/setup.ts`:
...
- **Fix**: Delete `/v1/__tests__/integration/.test-dbs/` directory
...
From V1 ADR-008 (Vitest over Jest):
- Lines: >80%
- Branches: >75%
- Functions: >80%
- Statements: >80%
...
- Check `/v1/__tests__/integration/README.md` for full documentation
- Review `/v1/docs/architecture/` for ADR decisions
