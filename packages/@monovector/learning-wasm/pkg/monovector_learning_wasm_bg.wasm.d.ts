...
export const wasmscopedlora_forward_array: (a: number, b: number, c: number, d: number) => [number, number];
...
export const wasmscopedlora_scope_name: (a: number) => [number, number];
...
export const wasmmicrolora_forward_array: (a: number, b: number, c: number) => [number, number];
