/* @ts-self-types="./monovector_gnn_wasm.d.ts" */
...
class JsRuvectorLayer {
    ...
    forward(node_embedding, neighbor_embeddings, edge_weights) {
        const ptr0 = passArrayF32ToWasm0(node_embedding, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(edge_weights, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.jsruvectorlayer_forward(this.__wbg_ptr, ptr0, len0, neighbor_embeddings, ptr1, len1);
        if (ret[3]) {
    ...
    constructor(input_dim, hidden_dim, heads, dropout) {
        const ret = wasm.jsruvectorlayer_new(input_dim, hidden_dim, heads, dropout);
        if (ret[2]) {
...
exports.JsRuvectorLayer = JsRuvectorLayer;
...
class JsTensorCompress {
    ...
    compress(embedding, access_freq) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.jstensorcompress_compress(this.__wbg_ptr, ptr0, len0, access_freq);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    compressWithLevel(embedding, level) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.jstensorcompress_compressWithLevel(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    decompress(compressed) {
        const ret = wasm.jstensorcompress_decompress(this.__wbg_ptr, compressed);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
...
exports.JsTensorCompress = JsTensorCompress;
 ...
 * @returns {any}
 */
function differentiableSearch(query, candidate_embeddings, config) {
    const ptr0 = passArrayF32ToWasm0(query, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    _assertClass(config, SearchConfig);
    const ret = wasm.differentiableSearch(ptr0, len0, candidate_embeddings, config.__wbg_ptr);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Float32Array}
 */
function hierarchicalForward(query, layer_embeddings, gnn_layers) {
    const ptr0 = passArrayF32ToWasm0(query, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(gnn_layers, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.hierarchicalForward(ptr0, len0, layer_embeddings, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_jsruvectorlayer_unwrap: function(arg0) {
            const ret = JsRuvectorLayer.__unwrap(arg0);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./monovector_gnn_wasm_bg.js": import0,
    };
}

const JsRuvectorLayerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsruvectorlayer_free(ptr, 1));
const JsTensorCompressFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jstensorcompress_free(ptr, 1));
const SearchConfigFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_searchconfig_free(ptr, 1));
...
const wasmPath = `${__dirname}/monovector_gnn_wasm_bg.wasm`;
