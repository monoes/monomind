 ...
 * V1 Shared Types
 *
 * Core type definitions used across all V1 modules
 */
...
export class ValidationError extends MonobrainError {
...
export class ExecutionError extends MonobrainError {
  constructor(message: string, details?: Record<string, unknown>) {
...
export class CoordinationError extends MonobrainError {
  constructor(message: string, details?: Record<string, unknown>) {
...
export class PluginError extends MonobrainError {
  constructor(message: string, details?: Record<string, unknown>) {
...
export class MemoryError extends MonobrainError {
  constructor(message: string, details?: Record<string, unknown>) {
