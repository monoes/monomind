/**
 * @monobrain/testing - Assertion Helpers
 *
 * Custom Vitest matchers and assertion utilities for V1 module testing.
...
/**
 * Assert that performance metrics meet V1 targets
 *
 * @example
...
/**
 * V1 performance metrics interface
 */
...
export function registerCustomMatchers(): void {
  expect.extend({
    ...
    toMeetPerformanceTargets(received: PerformanceMetrics) {
      const issues: string[] = [];
      ...
      return {
        ...
        message: () => issues.length === 0
          ? 'Performance metrics meet V1 targets'
