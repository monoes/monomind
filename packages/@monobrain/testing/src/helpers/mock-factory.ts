/**
 * @monobrain/testing - Mock Factory
 *
 * Factory functions for creating comprehensive mocks of V1 services and components.
...
import type { AgentType, AgentInstance, AgentMetrics } from '../fixtures/agent-fixtures.js';
