/**
 * V1 Monobrain Swarm Test Instance
 *
 * Creates isolated swarm instances for testing
 * Supports 15-agent V1 swarm topology testing
 */
...
export class SwarmTestInstance {
  ...
  constructor(
    ...
    private readonly agentTypes: AgentType[]
  ) {
  ...
  private createMockAgent(id: string, type: AgentType): MockedInterface<SwarmAgent> {
   ...
   */
  getAgent(type: AgentType): MockedInterface<SwarmAgent> | undefined {
