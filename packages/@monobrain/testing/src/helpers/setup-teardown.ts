/**
 * @monobrain/testing - Setup & Teardown Helpers
 *
 * Global setup and teardown utilities for V1 module testing.
 ...
 * });
 */
export function setupTests(config: TestConfig = {}): void {
  configureTestEnvironment({
    resetMocks: true,
