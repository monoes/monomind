/**
 * @monobrain/testing - MCP Fixtures
 *
 * Comprehensive mock MCP tools, contexts, and server configurations for testing.
 * Supports all MCP protocol operations and Monobrain tool integrations.
 *
 * Based on ADR-005 (MCP-first API design) and V1 specifications.
 */
...
/**
 * Pre-defined MCP tools for Monobrain
 */
