/**
 * V1 Monobrain Configuration Fixtures
 *
...
export const securityConfigs: Record<string, SecurityConfig> = {
  strict: {
    ...
    paths: {
      allowedDirectories: ['./packages/', './src/', './tests/'],
...
export const invalidConfigs = {
  ...
  swarm: {
    zeroAgents: createSwarmConfigFromBase('defaultConfig', { maxAgents: 0 }),
    negativeHeartbeat: createSwarmConfigFromBase('defaultConfig', {
