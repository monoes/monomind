...
export function create15AgentSwarmConfig(): AgentConfig[] {
  return [
    ...
    createAgentConfig('coder', { name: 'Integration Architect', type: 'integration-architect' as AgentType }),
    createAgentConfig('coder', { name: 'Performance Engineer', type: 'performance-engineer' as AgentType }),
    createAgentConfig('coder', { name: 'Core Architect', type: 'core-architect' as AgentType }),
    createAgentConfig('tester', { name: 'Test Architect', type: 'test-architect' as AgentType }),
    createAgentConfig('coder', { name: 'Project Coordinator', type: 'project-coordinator' as AgentType }),
    agentConfigs.coder,
    agentConfigs.reviewer,
    agentConfigs.tester,
    createAgentConfig('coder', { name: 'Planner Agent', type: 'planner' as AgentType }),
    createAgentConfig('coder', { name: 'Researcher Agent', type: 'researcher' as AgentType }),
  ];
}
