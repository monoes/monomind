...
[![npm version](https://img.shields.io/npm/v/@monobrain/testing.svg)](https://www.npmjs.com/package/@monobrain/testing)
[![npm downloads](https://img.shields.io/npm/dm/@monobrain/testing.svg)](https://www.npmjs.com/package/@monobrain/testing)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![TDD](https://img.shields.io/badge/TDD-London%20School-purple.svg)](https://github.com/nokhodian/monobrain)
[![ADR-008](https://img.shields.io/badge/ADR--008-Vitest-green.svg)](https://vitest.dev/)

> Comprehensive testing framework for V1 Monobrain modules. Implements London School TDD patterns with behavior verification, shared fixtures, and mock services.
...
```bash
npm install @monobrain/testing vitest --save-dev
```
...
const swarmConfigs = createV1SwarmAgentConfigs();
...
```typescript
import { createMockClock, measureTime } from "@monobrain/testing";
...
```typescript
import { createTestEmitter } from "@monobrain/testing";
...
```typescript
import { MockAgentDB } from "@monobrain/testing";
...
```typescript
import { MockSwarmCoordinator } from "@monobrain/testing";
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from "@monobrain/testing";
...
```typescript
import { registerCustomMatchers } from "@monobrain/testing";
...
expect(metrics).toMeetV1PerformanceTargets();
```
...
```typescript
import { setupV1Tests, configureTestEnvironment } from "@monobrain/testing";
...
```typescript
import { createSetupContext, createTestScope } from "@monobrain/testing";
...
```typescript
import { createPerformanceTestHelper } from "@monobrain/testing";
...
The testing framework includes assertions for V1 performance targets:
...
```typescript
import { assertV1PerformanceTargets, TEST_CONFIG } from "@monobrain/testing";
