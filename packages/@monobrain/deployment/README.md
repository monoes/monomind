...
[![npm version](https://img.shields.io/npm/v/@monobrain/deployment.svg)](https://www.npmjs.com/package/@monobrain/deployment)
[![npm downloads](https://img.shields.io/npm/dm/@monobrain/deployment.svg)](https://www.npmjs.com/package/@monobrain/deployment)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![CI/CD](https://img.shields.io/badge/CI%2FCD-Automated-green.svg)](https://github.com/nokhodian/monobrain)
[![Semantic Release](https://img.shields.io/badge/Semantic-Release-brightgreen.svg)](https://semantic-release.gitbook.io/)

> Release management, CI/CD, and versioning module for Monobrain v1.
...
```bash
npm install @monobrain/deployment
```
...
```typescript
import { prepareRelease } from '@monobrain/deployment';
...
```typescript
import { publishToNpm } from '@monobrain/deployment';
...
```typescript
import { validate } from '@monobrain/deployment';
...
```typescript
import { Publisher } from '@monobrain/deployment';
...
```typescript
import { Validator } from '@monobrain/deployment';
