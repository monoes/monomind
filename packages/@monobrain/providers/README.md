...
[![npm version](https://img.shields.io/npm/v/@monobrain/providers.svg)](https://www.npmjs.com/package/@monobrain/providers)
[![npm downloads](https://img.shields.io/npm/dm/@monobrain/providers.svg)](https://www.npmjs.com/package/@monobrain/providers)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Providers](https://img.shields.io/badge/Providers-6+-orange.svg)](https://github.com/nokhodian/monobrain)

> Multi-LLM Provider System for Monobrain V1 - unified interface for Anthropic, OpenAI, Google, Cohere, Ollama, and RuVector with intelligent load balancing, automatic failover, and cost optimization.
...
```bash
npm install @monobrain/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@monobrain/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@monobrain/providers';
...
- [@monobrain/embeddings](../embeddings) - Embedding generation
- [@monobrain/memory](../memory) - Vector storage and retrieval
