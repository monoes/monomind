 ...
 *
 * Usage:
 *   cd packages/@monobrain/providers
 *   npm run test:quick
 *
 * Or directly:
...
const TEST_PROMPT = 'Say "Hello from Monobrain!" Be brief.';
...
async function testOpenRouter() {
  ...
  const provider = new OpenAIProvider({
    config: {
      ...
      providerOptions: {
        headers: {
          'HTTP-Referer': 'https://monobrain.dev',
          'X-Title': 'Monobrain Test',
        },
      },
    },
    logger: consoleLogger,
...
async function main() {
  console.log('╔════════════════════════════════════════════════╗');
  console.log('║     Monobrain - Provider Test Suite       ║');
  console.log('╚════════════════════════════════════════════════╝');
