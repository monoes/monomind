...
[![npm version](https://img.shields.io/npm/v/@monobrain/integration.svg)](https://www.npmjs.com/package/@monobrain/integration)
[![npm downloads](https://img.shields.io/npm/dm/@monobrain/integration.svg)](https://www.npmjs.com/package/@monobrain/integration)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-001](https://img.shields.io/badge/ADR--001-Compliant-green.svg)](https://github.com/nokhodian/monobrain)

> Deep agentic-flow@alpha integration module for Monobrain V1 - ADR-001 compliance, code deduplication, SONA adapter, and Flash Attention coordinator.
...
```bash
npm install @monobrain/integration
...
```typescript
import { AgenticFlowBridge, createAgenticFlowBridge } from '@monobrain/integration';
...
- [@monobrain/neural](../neural) - SONA learning module
- [@monobrain/memory](../memory) - AgentDB memory
