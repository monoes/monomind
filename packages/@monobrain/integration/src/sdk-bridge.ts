 ...
 *
 * Provides API compatibility layer between monobrain v1 and
 ...
 * - API translation for v2 -> v1 migration
 * - Feature detection and graceful degradation
 * - Deprecated API support with warnings
 *
 * @module v1/integration/sdk-bridge
 ...
 * and API translation between monobrain and agentic-flow.
 */
