/**
 * @monobrain/integration - V1 Integration Module
 *
 ...
 * Usage:
 * ```typescript
 * import { createAgenticFlowBridge } from '@monobrain/integration';
 *
...
export const METADATA = {
  name: '@monobrain/integration',
  version: VERSION,
  description: 'Deep agentic-flow@alpha integration for monobrain v1',
  implements: ['ADR-001'],
  features: [
