/**
 * AgentAdapter - Bridge between Monobrain and agentic-flow Agents
 *
 * Provides bidirectional conversion and delegation patterns between:
 * - Monobrain v1 DDD agent architecture
 ...
 *
 * @module v1/integration/agent-adapter
...
/**
 * AgentAdapter - Bridges Monobrain and agentic-flow agents
 *
 ...
 *
 * // Convert agentic-flow agent to Monobrain agent
 * const { agent, success } = adapter.fromAgenticFlow(agenticFlowAgent);
 *
 * // Create Monobrain agent with agentic-flow delegation
...
export class AgentAdapter extends EventEmitter {
  ...
  /**
   * Convert agentic-flow agent to Monobrain AgenticFlowAgent
   *
   * This method creates a Monobrain agent wrapper around an existing
  ...
  fromAgenticFlow(
    ...
    try {
      // Map agentic-flow config to Monobrain config
  ...
  /**
   * Create a Monobrain agent with agentic-flow delegation
   *
   * This is the primary method for creating agents in v1 with
  ...
  /**
   * Map agentic-flow agent type to Monobrain AgentType
   */
  ...
  /**
   * Sync status between Monobrain and agentic-flow agents
   */
  private syncStatus(
    agent: AgenticFlowAgent,
    agenticFlowAgent: AgenticFlowAgent_External
  ): void {
    // Map agentic-flow status to Monobrain status
