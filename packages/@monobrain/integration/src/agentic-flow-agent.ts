/**
 * AgenticFlowAgent - Monobrain Agent with agentic-flow Delegation
 *
 * Per ADR-001: "Use agentic-flow's Agent base class for all agents"
 * This class wraps agentic-flow functionality while adding Monobrain specifics.
 *
 * This implements the adapter pattern to bridge between:
 * - Monobrain's agent lifecycle (v1 DDD architecture)
 ...
 *
 * @module v1/integration/agentic-flow-agent
...
/**
 * AgenticFlowAgent - Base class for all Monobrain v1 agents
 *
 * This class serves as the foundation for all agent types in Monobrain v1,
