 ...
 * the hook system. Pure CJS — no ESM imports of @monobrain/memory.
 *
 * Data files (all under .monobrain/data/):
 ...
 * on @monobrain/memory for the initial seed.
 */
function bootstrapFromMemoryFiles() {
  ...
  const candidates = [
    ...
    path.join(cwd, '.monobrain', 'memory'),
