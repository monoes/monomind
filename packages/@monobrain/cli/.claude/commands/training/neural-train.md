...
## Usage
```bash
npx monobrain neural train [options]
```
...
- **Location**: `.monobrain/neural/patterns.json`
- **Stats**: `.monobrain/neural/stats.json`
...
npx monobrain neural train -p coordination -e 50

# Train with custom learning rate
npx monobrain neural train -p optimization -l 0.005

# Train from file
npx monobrain neural train -d ./training-data.json

# Quick training (10 epochs)
npx monobrain neural train -e 10
```
...
npx monobrain neural patterns --action list

# Search patterns by query
npx monobrain neural patterns --action list -q "error handling"

# Analyze patterns
npx monobrain neural patterns --action analyze -q "coordination"
```
