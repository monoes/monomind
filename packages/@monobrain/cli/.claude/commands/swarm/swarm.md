...
Main swarm orchestration command for Monobrain v1.
...
```bash
npx @monobrain/cli@latest swarm init --topology hierarchical
npx @monobrain/cli@latest swarm status  # Only after completion
```
