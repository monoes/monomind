---
name: agent-types
description: Complete guide to all 87 available agent types in Monobrain v1
type: reference
---

# Agent Types Reference

Complete guide to all 87 available agent types in Monobrain v1.
...
| `v1-integration-architect` | v1 integration         | System integration      |
...
npx monobrain agent spawn --help

# Spawn any agent
npx monobrain agent spawn -t <agent-type>
```
