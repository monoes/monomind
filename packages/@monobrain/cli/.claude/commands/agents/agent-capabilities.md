...
Matrix of agent capabilities and their specializations for Monobrain v1.
...
```
hierarchical-coordinator: mcp__monobrain__swarm_*, mcp__monobrain__agent_*
mesh-coordinator: mcp__monobrain__swarm_*, mcp__monobrain__coordination_*
adaptive-coordinator: mcp__monobrain__topology_*, mcp__monobrain__swarm_*
```
...
code-review-swarm: mcp__github__*, mcp__monobrain__swarm_*
release-manager: mcp__github__*, mcp__monobrain__workflow_*
```
...
npx monobrain agent spawn -t coder --help
