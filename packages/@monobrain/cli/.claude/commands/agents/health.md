...
```bash
npx monobrain agent health [agent-id] [options]
```
...
npx monobrain agent health coder-lx7m9k2

# Continuous monitoring
npx monobrain agent health --watch

# Custom interval
npx monobrain agent health -w -i 10

# JSON output
npx monobrain agent health --format json
```
...
- `npx monobrain agent status` - Detailed agent info
- `npx monobrain agent metrics` - Performance metrics
- `npx monobrain doctor` - System-wide health
