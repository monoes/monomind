...
```bash
npx monobrain agent logs <agent-id> [options]
```
...
```bash
# View last 50 lines
npx monobrain agent logs coder-lx7m9k2

# View last 100 lines
npx monobrain agent logs coder-lx7m9k2 -n 100

# Follow logs (live)
npx monobrain agent logs coder-lx7m9k2 --follow

# Filter by level
npx monobrain agent logs coder-lx7m9k2 -l error

# Logs since time
npx monobrain agent logs coder-lx7m9k2 --since "1h"
npx monobrain agent logs coder-lx7m9k2 --since "2026-01-08T10:00:00"

# JSON output
npx monobrain agent logs coder-lx7m9k2 --format json
```
...
# Last 30 minutes
npx monobrain agent logs coder-lx7m9k2 --since "30m"

# Specific timestamp
npx monobrain agent logs coder-lx7m9k2 --since "2026-01-08T09:00:00"

# Today's logs
npx monobrain agent logs coder-lx7m9k2 --since "today"
```
...
- `npx monobrain agent status` - Current agent status
- `npx monobrain agent health` - Health monitoring
- `npx monobrain agent metrics` - Performance metrics
