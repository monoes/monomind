...
export class PluginDiscoveryService {
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      {
        id: '@monobrain/plugin-healthcare-clinical',
      ...
      {
        id: '@monobrain/plugin-financial-risk',
      ...
      {
        id: '@monobrain/plugin-legal-contracts',
        name: '@monobrain/plugin-legal-contracts',
      ...
      {
        id: '@monobrain/plugin-code-intelligence',
        name: '@monobrain/plugin-code-intelligence',
      ...
      {
        id: '@monobrain/plugin-test-intelligence',
        name: '@monobrain/plugin-test-intelligence',
      ...
      {
        id: '@monobrain/plugin-perf-optimizer',
        name: '@monobrain/plugin-perf-optimizer',
      ...
      {
        id: '@monobrain/plugin-neural-coordination',
        name: '@monobrain/plugin-neural-coordination',
      ...
      {
        id: '@monobrain/plugin-cognitive-kernel',
        name: '@monobrain/plugin-cognitive-kernel',
      ...
      {
        id: '@monobrain/plugin-quantum-optimizer',
        name: '@monobrain/plugin-quantum-optimizer',
      ...
      {
        id: '@monobrain/plugin-hyperbolic-reasoning',
        name: '@monobrain/plugin-hyperbolic-reasoning',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      ...
      '@monobrain/plugin-perf-optimizer',
      // Advanced AI/reasoning plugins
