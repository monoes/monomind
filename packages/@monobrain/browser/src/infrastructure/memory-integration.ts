/**
 * @monobrain/browser - Memory Integration
...
// ============================================================================
// Monobrain Memory Adapter
// ============================================================================

/**
 * Adapter for monobrain memory system with HNSW indexing
 */
export class MonobrainMemoryAdapter implements IMemoryAdapter {
  ...
  async store(entry: BrowserMemoryEntry): Promise<void> {
    ...
    try {
      // This would call monobrain memory_store MCP tool
...
export class BrowserMemoryManager {
  ...
  constructor(sessionId: string, adapter?: IMemoryAdapter) {
    ...
    this.adapter = adapter || new MonobrainMemoryAdapter();
  }
...
export function getMemoryAdapter(): IMemoryAdapter {
  if (!defaultAdapter) {
    defaultAdapter = new MonobrainMemoryAdapter();
  }
