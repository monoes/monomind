...
import { interruptTools } from './interrupt-tools.js'; // Task 16
import { v2CompatTools, getV2Tool, mapV2ToCurrentToolName } from './v2-compat-tools.js';
// Task 19: TaskDAG tool
import { dagTools } from './task-dag-tools.js';
// Task 21: WorkflowDSL tool
...
// Swarm tools
export { initSwarmTool, swarmStatusTool, scaleSwarmTool, subgraphComposeTool, swarmTools, } from './swarm-tools.js';
// Task 19: TaskDAG
export { dagRunTool, dagTools } from './task-dag-tools.js';
// Task 21: WorkflowDSL
export { workflowRunTool, workflowTools } from './workflow-tools.js';
// Memory tools
...
export function getAllTools(includeV2Compat = true) {
    const currentTools = [
        ...
        ...sonaTools,
        ...federationTools,
    ...interruptTools,    // Task 16: HumanInTheLoop
        ...dagTools,       // Task 19: TaskDAG
        ...workflowTools,  // Task 21: WorkflowDSL
    ];
    // Include V2 compatibility tools if requested (default: true for backward compatibility)
    if (includeV2Compat) {
        return [...currentTools, ...v2CompatTools];
    }
    return currentTools;
}
/**
 * Get only V1 tools (excludes V2 compatibility tools)
 */
