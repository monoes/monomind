# MCP Tools - ADR-005: MCP-First API Design
...
- `/workspaces/monobrain/packages/mcp/types.ts` - MCP type definitions
- `/workspaces/monobrain/packages/mcp/server.ts` - MCP server implementation
- `/workspaces/monobrain/packages/mcp/tool-registry.ts` - Tool registration system
- `/workspaces/monobrain/CLAUDE.md` - Project documentation
