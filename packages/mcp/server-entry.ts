 ...
 *
 * Usage:
 *   npx tsx packages/mcp/server-entry.ts [options]
 *
 * Options:
 ...
 *
 * @module @monobrain/mcp/server-entry
 * @version 3.0.0
 */
...
Examples:
  npx tsx packages/mcp/server-entry.ts
  npx tsx packages/mcp/server-entry.ts --transport http --port 8080
  npx tsx packages/mcp/server-entry.ts --tools agent/spawn,swarm/init
`);
}
...
async function main(): Promise<void> {
  ...
  logger.info('Starting Monobrain MCP Server', {
