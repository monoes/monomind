    ...
    try {
      ...
      if (!_isDevRepo) {
        ...
        if (bundledDir) {
          ...
          var helpersToCheck = ['hook-handler.cjs', 'statusline.cjs', 'router.cjs', 'monograph-freshen.cjs', 'control-start.cjs', 'intelligence.cjs', 'auto-memory-hook.mjs', 'build-skill-registry.cjs'];
