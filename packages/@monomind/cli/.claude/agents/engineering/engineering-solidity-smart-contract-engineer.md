...
description: Solidity engineer for EVM smart contracts — gas optimization, upgradeable proxies, DeFi protocols, and security-first design on Ethereum and L2s
when_to_use: Use when writing or optimizing Solidity contracts, proxies, or DeFi protocols; for an independent audit use Blockchain Security Auditor
tags: [blockchain, solidity, smart-contracts, defi, evm]
