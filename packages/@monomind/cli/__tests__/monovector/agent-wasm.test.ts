/**
 * Tests for @monoes/rvagent-wasm integration module
 *
...
const mockTemplates = [
  { id: 'coder', name: 'Coder Agent', description: 'Coding assistant', category: 'development', tags: ['code'], version: '1.0.0', author: 'MonoVector', builtin: true },
  { id: 'tester', name: 'Testing Agent', description: 'QA agent', category: 'testing', tags: ['test'], version: '1.0.0', author: 'MonoVector', builtin: true },
];
...
} from '../../src/monovector/agent-wasm.js';
