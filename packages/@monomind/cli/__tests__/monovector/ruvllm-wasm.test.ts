 ...
 * Mocks @monoes/ruvllm-wasm since it may not be installed in CI.
 */
...
describe('ruvllm-wasm integration', () => {
  ...
  describe('isRuvllmWasmAvailable', () => {
    it('should return true when module is available', async () => {
      const { isRuvllmWasmAvailable } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('getRuvllmStatus', () => {
    it('should return status with version', async () => {
      const { getRuvllmStatus } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createHnswRouter', () => {
    it('should create router with dimensions and maxPatterns', async () => {
      const { createHnswRouter } = await import('../../src/monovector/ruvllm-wasm.js');
    ...
    it('should enforce HNSW_MAX_SAFE_PATTERNS limit', async () => {
      const { createHnswRouter, HNSW_MAX_SAFE_PATTERNS } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createSonaInstant', () => {
    it('should create with default config', async () => {
      const { createSonaInstant } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createMicroLora', () => {
    it('should create with config', async () => {
      const { createMicroLora } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('formatChat', () => {
    it('should format with preset template', async () => {
      const { formatChat } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createKvCache', () => {
    it('should create with defaults', async () => {
      const { createKvCache } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createGenerateConfig', () => {
    it('should create config JSON', async () => {
      const { createGenerateConfig } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createBufferPool', () => {
    it('should create with capacity', async () => {
      const { createBufferPool } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('createInferenceArena', () => {
    it('should create with raw capacity', async () => {
      const { createInferenceArena } = await import('../../src/monovector/ruvllm-wasm.js');
  ...
  describe('HNSW_MAX_SAFE_PATTERNS', () => {
    it('should be 1024', async () => {
      const { HNSW_MAX_SAFE_PATTERNS } = await import('../../src/monovector/ruvllm-wasm.js');
