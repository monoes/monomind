...
import { statusCommand as patternStatusCommand, patternsCommand, trainCommand, predictCommand, } from './neural-core.js';
...
const workerRunCommand = {
    ...
    action: async (ctx) => {
        const name = ctx.args[0] || ctx.flags['name'];
        if (!name) {
