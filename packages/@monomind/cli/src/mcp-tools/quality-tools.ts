...
export const qualityTools: MCPTool[] = [
  {
    ...
    handler: wrap(generateTestsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(tddCycleHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(suggestTestsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(analyzeCoverageHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(prioritizeGapsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(trackTrendsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(evaluateGateHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(assessReadinessHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(calculateRiskHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(predictDefectsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(analyzeDefectHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(findSimilarDefectsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(securityScanHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(auditComplianceHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(detectSecretsHandler as Parameters<typeof wrap>[0]),
  },
  {
    ...
    handler: wrap(chaosInjectHandler as Parameters<typeof wrap>[0]),
  },
];
