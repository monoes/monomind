...
export function generateKimiAgentsMd(): string {
  const lines = [
    ...
    '`monograph_impact`, `memory_search`, `memory_store`, and more.',
    '',
    ...
    '',
    '## Memory',
    'Persist insights across sessions: `mcp__monomind__memory_store` to save,',
    '`mcp__monomind__memory_search` to recall. Use namespacing to keep project/agent',
    'memory separate.',
    '',
