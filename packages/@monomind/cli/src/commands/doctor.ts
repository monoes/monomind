...
export const doctorCommand: Command = {
  ...
  options: [
    ...
    },
    {
      ...
      short: 'c',
      description:
        'Check specific component (version, node, npm, config, project-root, memory, api, git, mcp, claude, disk, native, typescript, monograph, graph-freshness, memory-pkg, helpers, monoes, gates, gitignore, registry, memory-proficiency, monoes-tools, monoes-token, metrics-freshness, security-audit, documents, platforms, crash-reporting)',
      type: 'string',
    },
