...
import { DEFAULT_KEYWORD_ROUTES, KeywordPreFilter } from '../keyword-pre-filter.js';
  ...
  describe('custom rules', () => {
    ...
    it('custom rules are prepended (take priority)', () => {
      const custom = new KeywordPreFilter([
        {
          pattern: /CVE-\d+/i,
          agentSlug: 'my-cve-handler',
          routeName: 'my-cve',
          description: 'Override CVE',
        },
      ]);
