...
export function computeTargetThresholds(sample) {
...
export function labelForCategory(cat) {
    return RECOMMENDATION_CATEGORIES[cat].label;
}
export function compactLabelForCategory(cat) {
    return RECOMMENDATION_CATEGORIES[cat].compactLabel;
}
//# sourceMappingURL=target-thresholds.js.map