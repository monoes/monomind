...
export function computeDistributionThresholds(scores) {
    if (scores.length === 0)
        return { ...THRESHOLD_FLOORS };
...
export function formatDistributionThresholds(t) {
    return [
        `Fan-in  p25=${t.fanInP25}  p75=${t.fanInP75}  p95=${t.fanInP95}`,
        `Fan-out p90=${t.fanOutP90}  p95=${t.fanOutP95}`,
    ].join('\n');
}
//# sourceMappingURL=distribution-thresholds.js.map