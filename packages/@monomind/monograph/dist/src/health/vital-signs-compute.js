...
export function computeVitalSignsScore(vitals) {
    let score = 100;
...
export function buildSnapshot(vitals, score) {
    return {
        timestamp: Date.now(),
        score,
        vitals,
...
export function loadSnapshots(snapshotPath) {
...
//# sourceMappingURL=vital-signs-compute.js.map