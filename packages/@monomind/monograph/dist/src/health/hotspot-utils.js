...
export function computeNormalizationMaxima(files, percentile = 0.95) {
    if (files.length < 2) {
...
export function normalizeHotspotScore(rawChurn, rawComplexity, maxima) {
...
//# sourceMappingURL=hotspot-utils.js.map