...
function indentJsonValue(json, spaces) {
...
export function generateJsonc(config, sources) {
...
export function parseJsoncComments(input) {
    const stripped = input.replace(/\/\/[^\n]*/g, '').replace(/\/\*[\s\S]*?\*\//g, '');
    return JSON.parse(stripped);
}
export { indentJsonValue };
//# sourceMappingURL=jsonc-gen.js.map