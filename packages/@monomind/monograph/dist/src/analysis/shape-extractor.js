 ...
 */
function extractObjectBody(source, start) {
    let depth = 0;
    let bodyStart = -1;
 ...
 */
export function extractHandlerReturnKeys(source) {
    const keys = new Set();
 ...
 */
export function extractAccessedKeys(source, varNames = ['data', 'result', 'response', 'res', 'json', 'body']) {
    const keys = new Set();
 ...
 */
export function compareShapes(returnedKeys, accessedKeys) {
