 ...
 */
async function upsertContextBlock(filePath) {
...
// ─── Per-target handlers ──────────────────────────────────────────────────────
async function handleClaude(repoPath, result) {
...
async function handleAgentsMd(repoPath, result) {
...
// ─── Public API ───────────────────────────────────────────────────────────────
const ALL_TARGETS = ['claude', 'agents-md'];
 ...
 */
export async function injectAiContext(options) {
