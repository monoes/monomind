...
function findExportSpan(lines, startIdx) {
...
function removeSpecifierFromList(specifierList, exportName) {
...
function applySurgery(fileContent, exportName, line, expectType) {
...
export function removeNameFromExportList(fileContent, exportName, line) {
    return applySurgery(fileContent, exportName, line, false);
}
export function removeTypeFromExportList(fileContent, exportName, line) {
    return applySurgery(fileContent, exportName, line, true);
}
export function promoteToTypeExport(fileContent, exportName, line) {
    const lines = fileContent.split('\n');
    const idx = line - 1;
    if (idx < 0 || idx >= lines.length) {
        return { modified: false, newContent: fileContent, linesRemoved: 0 };
...
export function applyExportSurgeries(fileContent, surgeries) {
...
//# sourceMappingURL=export-surgery.js.map