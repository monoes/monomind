...
export function fixUnusedExports(fixes, options) {
    ...
    for (const [filePath, fileFixes] of byFile) {
        ...
        for (const fix of sortedFixes) {
            ...
            if (fix.fixType === 'remove-export-keyword') {
                ...
                const newLine = originalLine.replace(/^(\s*)export (default function|function|const|class|type|interface|default )/, '$1$2');
