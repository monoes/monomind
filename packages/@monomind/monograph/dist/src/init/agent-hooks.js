...
export function buildAgentsMdBlock(command) {
    return [
        AGENTS_BLOCK_START,
        '',
...
export function mergeAgentsMdBlock(existing, block) {
...
export function removeAgentsMdBlock(content) {
...
export function mergeClaudeCodeSettings(existing, entry) {
...
export const DEFAULT_SETUP_RESULT = {
