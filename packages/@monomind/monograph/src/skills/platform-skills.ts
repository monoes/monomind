...
export function installPlatformSkill(
  ...
  const outputDir =
    platformConfig.subPath.length > 0 ? path.join(repoPath, ...platformConfig.subPath) : repoPath;
...
function renderMonographSkillDoc(platform: string): string {
  ...
  lines.push('');
  lines.push(
    'This file was generated by Monograph to document available skills for this platform.',
  );
  lines.push('');
  lines.push('## Usage');
  lines.push('');
  lines.push(
    'Monograph indexes your codebase and exposes symbol-level knowledge to AI assistants.',
  );
