...
// scratch dir so no ambient ~/.gitconfig leaks in either. This is a
// checked-in test controlling its own fixture's ambient state, not a role
// editing its env guard: policy-git.ts's ENV_SETTERS rule governs shell
