...
function makeNode(id: string, label = 'Function', name = id, filePath?: string): MonographNode {
  return { id, label: label as MonographNode['label'], name, isExported: false, filePath };
}
