...
const SARIF_RULES: SarifRule[] = [
  {
    ...
    fullDescription: {
      text: 'A file or module has an unusually high number of incoming dependencies, making it a central point of coupling. Consider splitting this module into smaller, more focused units.',
    },
  ...
  },
  {
    ...
    fullDescription: {
      text: 'A file is not reachable from any known entry point. It may be dead code that can be safely removed.',
    },
  ...
  },
  {
    ...
    fullDescription: {
      text: 'A circular import chain was detected between files. Circular imports can cause initialization order issues and make the codebase harder to understand.',
    },
  ...
  },
  {
    ...
    fullDescription: {
      text: 'A file acts as a bridge between multiple community clusters, creating high cross-community coupling. This may indicate architectural boundaries are not being respected.',
    },
  ...
  },
  {
    ...
    fullDescription: {
      text: 'A file is both a churn hotspot (frequently modified) and highly connected in the dependency graph. Changes here have wide blast radius and high risk of regression.',
    },
...
export function exportHealthSarif(findings: SarifHealthFinding[], root?: string): SarifDocument {
  ...
  return {
    ...
    version: '2.1.0',
    runs: [
      { tool: { driver: { name: 'monograph-health', version: PKG_VERSION, rules } }, results },
    ],
  };
}
