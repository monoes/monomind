...
describe('live-accept — style-element edge cases', () => {
  ...
  // separate closer, so it got stuck forever and missed data-monodesign-variant
  // divs that came after.
  it('finds the accepted variant after a JSX self-closing <style /> block', () => {
    const html = `<body>
  <!-- monodesign-variants-start SELFC -->
  <div data-monodesign-variants="SELFC" data-monodesign-variant-count="3" style="display: contents">
    <div data-monodesign-variant="original">
      <p class="hook">original text</p>
    </div>
    <style data-monodesign-css="SELFC" dangerouslySetInnerHTML={{ __html: '@scope ([data-monodesign-variant="1"]) { .hook { color: red; } }' }} />
  ...
  <!-- monodesign-variants-end SELFC -->
    ...
    // no carbonize block, no data-monodesign-variant wrapper (it would serve no purpose).
    assert.ok(!after.includes('monodesign-carbonize-start'), 'no carbonize block (self-closing style has no body)');
    assert.ok(!after.includes('monodesign-variants-start'), 'variant markers removed');
  ...
  it('finds the accepted variant after a single-line <style>…</style> block', () => {
    const html = `<body>
  <!-- monodesign-variants-start ONELINE -->
  <div data-monodesign-variants="ONELINE" data-monodesign-variant-count="3" style="display: contents">
    <div data-monodesign-variant="original"><p class="hook">original</p></div>
    <style data-monodesign-css="ONELINE">@scope ([data-monodesign-variant="1"]) { .hook { color: red; } }</style>
    <div data-monodesign-variant="1"><p class="hook">variant one</p></div>
    <div data-monodesign-variant="2" style="display: none"><p class="hook">variant two</p></div>
    <div data-monodesign-variant="3" style="display: none"><p class="hook">variant three</p></div>
  </div>
  <!-- monodesign-variants-end ONELINE -->
</body>`;
    writeFileSync(join(tmp, 'page.html'), html);
    ...
    const after = readFileSync(join(tmp, 'page.html'), 'utf-8');
    assert.ok(after.includes('data-monodesign-variant="3"'), 'accepted wrapper for variant 3 present');
  ...
  it('finds the accepted variant after a multi-line <style>…</style> block (regression baseline)', () => {
    const html = `<body>
  <!-- monodesign-variants-start MULTI -->
  <div data-monodesign-variants="MULTI" data-monodesign-variant-count="3" style="display: contents">
    <div data-monodesign-variant="original"><p class="hook">original</p></div>
    <style data-monodesign-css="MULTI">
      @scope ([data-monodesign-variant="1"]) { .hook { color: red; } }
      @scope ([data-monodesign-variant="2"]) { .hook { color: green; } }
    </style>
    <div data-monodesign-variant="1"><p class="hook">variant one</p></div>
    <div data-monodesign-variant="2" style="display: none"><p class="hook">variant two</p></div>
  </div>
  <!-- monodesign-variants-end MULTI -->
</body>`;
    writeFileSync(join(tmp, 'page.html'), html);
    ...
    const after = readFileSync(join(tmp, 'page.html'), 'utf-8');
    assert.ok(after.includes('data-monodesign-variant="1"'), 'accepted wrapper for variant 1 present');
  ...
  it('carbonize does not double-wrap when the variants block uses JSX template literals on their own lines', () => {
    const tsx = `export default function App() {\n` +
      ...
      `    <main>\n` +
      `      <>\n` +
      `        {/* monodesign-variants-start TPL */}\n` +
      `        <div data-monodesign-variants="TPL" data-monodesign-variant-count="2" style={{ display: 'contents' }}>\n` +
      `          <div data-monodesign-variant="original"><p className="hook">orig</p></div>\n` +
      `          <style data-monodesign-css="TPL">\n` +
      "            {`\n" +
      `              @scope ([data-monodesign-variant="1"]) { .hook { color: red; } }\n` +
      `              @scope ([data-monodesign-variant="2"]) { .hook { color: green; } }\n` +
      "            `}\n" +
      `          </style>\n` +
      `          <div data-monodesign-variant="1"><p className="hook">variant one</p></div>\n` +
      `          <div data-monodesign-variant="2" style={{ display: 'none' }}><p className="hook">variant two</p></div>\n` +
      `        </div>\n` +
      `        {/* monodesign-variants-end TPL */}\n` +
      `      </>\n` +
      `    </main>\n` +
      `  );\n` +
      `}\n`;
    ...
    const carbonStyleMatch = after.match(/<style data-monodesign-css="TPL">([\s\S]*?)<\/style>/);
    ...
    assert.ok(inner.includes('@scope ([data-monodesign-variant="1"])'), 'variant-1 scope kept');
    assert.match(
      after,
      /\n          <div data-monodesign-variant="1" style=\{\{ display: 'contents' \}\}>\n            <p className="hook">variant one<\/p>\n          <\/div>/,
  ...
  it('carbonize does not double-wrap when JSX template-literal punctuation hugs the CSS lines', () => {
    const tsx = `export default function App() {\n` +
      ...
      `    <main>\n` +
      `      <>\n` +
      `        {/* monodesign-variants-start INLINE */}\n` +
      `        <div data-monodesign-variants="INLINE" data-monodesign-variant-count="2" style={{ display: 'contents' }}>\n` +
      `          <div data-monodesign-variant="original"><p className="hook">orig</p></div>\n` +
      `          <style data-monodesign-css="INLINE">\n` +
      "            {`@scope ([data-monodesign-variant=\"1\"]) { .hook { color: red; } }\n" +
      "             @scope ([data-monodesign-variant=\"2\"]) { .hook { color: green; } }`}\n" +
      `          </style>\n` +
      `          <div data-monodesign-variant="1"><p className="hook">variant one</p></div>\n` +
      `          <div data-monodesign-variant="2" style={{ display: 'none' }}><p className="hook">variant two</p></div>\n` +
      `        </div>\n` +
      `        {/* monodesign-variants-end INLINE */}\n` +
      `      </>\n` +
      `    </main>\n` +
      `  );\n` +
      `}\n`;
    ...
    const after = readFileSync(join(tmp, 'App.tsx'), 'utf-8');
    const inner = after.match(/<style data-monodesign-css="INLINE">([\s\S]*?)<\/style>/)[1];
    const openCount = (inner.match(/\{`/g) || []).length;
    const closeCount = (inner.match(/`\}/g) || []).length;
  ...
  it('carbonize preserves nested JSX indentation when the wrapper starts at column 0', () => {
    const tsx = `<div data-monodesign-variants="ROOTIND" data-monodesign-variant-count="2" style={{ display: 'contents' }}>
  {/* monodesign-variants-start ROOTIND */}
  <div data-monodesign-variant="original">
    <section className="hook">
      <span>original</span>
    </section>
  </div>
  <style data-monodesign-css="ROOTIND">{\`@scope ([data-monodesign-variant="1"]) { .hook { color: red; } }\`}</style>
  <div data-monodesign-variant="1">
    <section className="hook">
  ...
  {/* monodesign-variants-end ROOTIND */}
</div>
`;
  ...
  return (
    ...
    // the outer wrapper, and no monodesign markers/data attributes.
    assert.ok(!after.includes('data-monodesign-variants'),
      `outer wrapper div must be fully removed; got:\n${after}`);
    assert.ok(!after.includes('data-monodesign-variant'),
      `original-div wrapper must be fully removed; got:\n${after}`);
    assert.ok(!after.includes('monodesign-variants-start'),
  ...
  return (
    <main>
      <div
        className="monodesign-preview-shell"
${extraAttrs}
        data-monodesign-variants="LONGOPEN"
        data-monodesign-variant-count="2"
        style={{ display: 'contents' }}
      >
        {/* monodesign-variants-start LONGOPEN */}
        {/* Original */}
        <div data-monodesign-variant="original">
          <aside className="card">
            <h1>Original</h1>
        ...
        <div data-monodesign-variant="1"><aside className="card"><h1>Variant</h1></aside></div>
        {/* monodesign-variants-end LONGOPEN */}
      </div>
      <div className="next-card">After</div>
    </main>
  );
    ...
    const after = readFileSync(join(tmp, 'App.tsx'), 'utf-8');
    assert.doesNotMatch(after, /data-monodesign-variants/);
    assert.doesNotMatch(after, /monodesign-variants-start/);
  ...
  return (
    <main>
      <div data-monodesign-variants="ACTIVE" data-monodesign-variant-count="2" style={{ display: 'contents' }}>
        <div className="historical-marker-note">
          {/* monodesign-variants-end OLD */}
        </div>
        {/* monodesign-variants-start ACTIVE */}
        {/* Original */}
        <div data-monodesign-variant="original">
          <aside className="card">
            <h1>Original</h1>
        ...
        {/* Variants: insert below this line */}
        <div data-monodesign-variant="1"><aside className="card"><h1>Variant</h1></aside></div>
        {/* monodesign-variants-end ACTIVE */}
      </div>
      <div className="next-card">After</div>
    </main>
  );
    ...
    const after = readFileSync(join(tmp, 'App.tsx'), 'utf-8');
    assert.doesNotMatch(after, /data-monodesign-variants/);
    assert.doesNotMatch(after, /monodesign-variants-start ACTIVE/);
    assert.doesNotMatch(after, /monodesign-variants-end OLD/);
    assert.match(after, /<aside className="card">\s*<h1>Original<\/h1>\s*<\/aside>/m);
    assert.ok(after.includes('<div className="next-card">After</div>'));
  });
  ...
  return (
    <main>
      <div data-monodesign-variants="INDENTACC" data-monodesign-variant-count="3" style={{ display: "contents" }}>
        {/* monodesign-variants-start INDENTACC */}
        {/* Original */}
        <div data-monodesign-variant="original">
          <aside className="card">
            <h1 className="hero-title">Hero</h1>
        ...
        {/* Variants: insert below this line */}
        <div data-monodesign-variant="1"><aside className="card variant-one"><h1 className="hero-title">Hero</h1></aside></div>
        {/* monodesign-variants-end INDENTACC */}
      </div>
    </main>
  );
}`;
  ...
  it('discard restores the original element after a JSX self-closing <style />', () => {
    const html = `<body>
  <!-- monodesign-variants-start DISC -->
  <div data-monodesign-variants="DISC" data-monodesign-variant-count="2" style="display: contents">
    <div data-monodesign-variant="original"><p class="hook">ORIGINAL CONTENT</p></div>
    <style data-monodesign-css="DISC" dangerouslySetInnerHTML={{ __html: '@scope ([data-monodesign-variant="1"]) { .hook { color: red; } }' }} />
    <div data-monodesign-variant="1"><p class="hook">variant one</p></div>
    <div data-monodesign-variant="2" style="display: none"><p class="hook">variant two</p></div>
  </div>
  <!-- monodesign-variants-end DISC -->
</body>`;
    writeFileSync(join(tmp, 'page.html'), html);
    ...
    assert.ok(!after.includes('monodesign-variants-start'), 'wrapper markers gone');
...
describe('live-accept — insert sessions', () => {
  ...
  <!-- monodesign-variants-start ${id} -->
  <div data-monodesign-variants="${id}" data-monodesign-mode="insert" data-monodesign-variant-count="2" style="display: contents">
    <!-- Variants: insert below this line -->
    <style data-monodesign-css="${id}">@scope ([data-monodesign-variant="1"]) { .cta { color: red; } }</style>
    <div data-monodesign-variant="1"><p class="cta">Variant one</p></div>
    <div data-monodesign-variant="2" style="display: none"><p class="cta">Variant two</p></div>
  </div>
  <!-- monodesign-variants-end ${id} -->
