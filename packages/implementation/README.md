...
| ------------------------------- | ------------------------------------- |
| [v1-adrs.md](./adrs/v1-adrs.md) | All 10 ADRs (001-010) master document |
...
| [v1-assessment.md](./architecture/v1-assessment.md)                                         | V1 current state assessment               |
...
| Document                                                       | Description                |
| -------------------------------------------------------------- | -------------------------- |
| [MIGRATION-GUIDE.md](./migration/MIGRATION-GUIDE.md)           | V2 to V1 migration guide   |
| [v1-migration-roadmap.md](./migration/v1-migration-roadmap.md) | Detailed migration roadmap |

### Optimization

| Document                                                                | Description                      |
| ----------------------------------------------------------------------- | -------------------------------- |
| [V1-OPTIMIZATION-ROADMAP.md](./optimization/V1-OPTIMIZATION-ROADMAP.md) | Performance optimization targets |
