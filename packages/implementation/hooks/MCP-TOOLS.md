# Hooks MCP Tools Reference

## Overview

The Hooks MCP Tools provide programmatic access to the V1 hooks system through the Model Context Protocol. All tools follow ADR-005 (MCP-First API Design) conventions.
...
{
  "success": true,
  "repositoryPath": "/workspaces/monobrain",
  "statistics": {
    "filesAnalyzed": 247,
