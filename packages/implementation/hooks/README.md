...
### 3. MCP Tools (`packages/mcp/tools/hooks-tools.ts`)
...
V1 introduces **SwarmCommunication** for agent-to-agent coordination within swarms.
...
V1 maintains full backward compatibility with V2 hooks:
