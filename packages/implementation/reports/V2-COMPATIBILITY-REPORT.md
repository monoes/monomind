...
| mcp**ruv-swarm**swarm_init     | OK     | swarm/init          |
| mcp**ruv-swarm**swarm_status   | OK     | swarm/status        |
| mcp**ruv-swarm**agent_spawn    | OK     | agent/spawn         |
| mcp**ruv-swarm**agent_list     | OK     | agent/list          |
| mcp**ruv-swarm**agent_metrics  | OK     | agent/status        |
| memory/query                   | OK     | memory/search       |
| memory/store                   | OK     | memory/store        |
| memory/delete                  | OK     | memory/delete       |
| mcp**ruv-swarm**memory_usage   | OK     | memory/list         |
...
| mcp**ruv-swarm**neural_status  | OK     | hooks/metrics       |
| mcp**ruv-swarm**neural_train   | OK     | hooks/pretrain      |
...
// V1 tool call (with compatibility layer)
const agent = await mcp.callTool("dispatch_agent", {
  type: "coder",
  name: "my-agent",
  priority: 8,
...
| Feature        | V2 Status    | V1 Status                  | Compatibility |
| -------------- | ------------ | -------------------------- | ------------- |
...
### A. V2 to V1 Tool Name Mapping

| V2 Tool Name                   | V1 Tool Name    |
| ------------------------------ | --------------- |
...
| mcp**ruv-swarm**swarm_init     | swarm/init      |
| mcp**ruv-swarm**swarm_status   | swarm/status    |
| mcp**ruv-swarm**agent_spawn    | agent/spawn     |
| mcp**ruv-swarm**agent_list     | agent/list      |
| mcp**ruv-swarm**agent_metrics  | agent/status    |
| memory/query                   | memory/search   |
| mcp**ruv-swarm**memory_usage   | memory/list     |
| config/get                     | config/load     |
| config/update                  | config/save     |
| mcp**ruv-swarm**neural_status  | hooks/metrics   |
| mcp**ruv-swarm**neural_train   | hooks/pretrain  |

### B. V2 to V1 Import Aliases
...
| Version    | Changes                               |
| ---------- | ------------------------------------- |
| **V1.0.0** | Compatibility mode enabled by default |
| **v1.1.0** | Deprecation warnings added            |
| **v1.2.0** | Compatibility mode opt-in             |
| **v4.0.0** | V2 compatibility removed              |

---

_Report generated by V2CompatibilityValidator_
_For more information, see [v1/docs/v1-migration/BACKWARD-COMPATIBILITY.md](../v1-migration/BACKWARD-COMPATIBILITY.md)_
