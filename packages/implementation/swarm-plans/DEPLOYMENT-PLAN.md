...
```
V1.0.0-alpha.1  → First internal alpha
V1.0.0-alpha.5  → Feature complete alpha
V1.0.0-beta.1   → Public beta
V1.0.0-beta.3   → Feature freeze
V1.0.0-rc.1     → Release candidate
V1.0.0-rc.2     → Final RC (if needed)
...
See [MIGRATION-GUIDE.md](./packages/implementation/migration/MIGRATION-GUIDE.md)
      ...
      - name: Create GitHub Release
        ...
        with:
          body: |
            ...
            ## Documentation
            - [Migration Guide](./packages/implementation/migration/MIGRATION-GUIDE.md)
...
const CONFIG_MIGRATIONS: MigrationRule[] = [
  // Renamed settings
  { v2Path: "swarm.coordinator", v1Path: "swarm.unifiedCoordinator" },
  { v2Path: "memory.backend", v1Path: "memory.agentDB" },

  // Transformed settings
  {
    v2Path: "security.hashAlgorithm",
    v1Path: "security.passwordHashing",
    transform: (v) => (v === "sha256" ? "bcrypt" : v),
  },

  // Removed settings (warn user)
  { v2Path: "deprecated.hiveMindMode", v1Path: null },

  // New defaults
  {
    v2Path: null,
    v1Path: "agenticFlow.enabled",
    transform: () => true,
  },
];

export function migrateConfig(v2Config: any): {
  v1Config: any;
  warnings: string[];
} {
  const v1Config = {};
