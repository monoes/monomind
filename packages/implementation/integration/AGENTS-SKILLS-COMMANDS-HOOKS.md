...
### 1.3 Agent Template Enhancement (v1)
...
### 2.3 Skill Template Enhancement (v1)
...
### 3.3 Command Template Enhancement (v1)
...
### 4.2 v1 Solution: Single Source of Truth
...
- [ ] Create v1 agent directory structure
- [ ] Move agents to new categories
- [ ] Update agent templates with agentic-flow config
- [ ] Create v1 skill directory structure
- [ ] Move skills to domain groups
- [ ] Create v1 command directory structure
...
| System | v2 State | v1 Target | Improvement |
|--------|----------|-----------|-------------|
