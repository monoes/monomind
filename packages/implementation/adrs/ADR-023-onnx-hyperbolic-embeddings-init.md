...
3. **Migration gaps**: V2→V1 migration doesn't convert embedding formats
...
│  │ command  │    │ migration    │    │ V2 → V1 format  │   │
│  └──────────┘    └──────────────┘    └─────────────────┘   │
│                          │                    │              │
│                          ▼                    ▼              │
│                  ┌──────────────┐    ┌─────────────────┐   │
...
- **Migration support**: Smooth V2→V1 transition
