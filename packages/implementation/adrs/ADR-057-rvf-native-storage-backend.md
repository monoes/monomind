...
Backward Compatibility Tests:
  ✓ v1.5.x .db files open correctly in v1.6+ with auto-migration
  ✓ v1.5.x .json files open correctly in v1.6+ with auto-migration
...
- [RuVector Format Specification](https://github.com/nokhodian/ruvector/blob/main/crates/rvf/README.md)
- [ruvLLM Self-Learning LLM Engine](https://github.com/nokhodian/ruvector/blob/main/crates/ruvllm/README.md)
...
- [ADR-053: AgentDB v1 Controller Activation](./ADR-053-agentdb-v1-controller-activation.md)
