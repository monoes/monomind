...
- Remaining P0 item (#1282 Windows) requires platform-specific CI matrix — target v1.5.3.
- Remaining P1 items (#1283, #1287, #1291) should ship as v1.6.0 with macOS CI.
