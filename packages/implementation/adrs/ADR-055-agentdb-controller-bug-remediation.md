# ADR-055: AgentDB v1 Controller Bug Remediation
...
ADR-053 introduced 8 new controllers and 6 MCP tools for AgentDB v1 integration. A deep review revealed 7 critical bugs, 5 high-severity issues, and several medium issues that made all 6 new tools non-functional.
