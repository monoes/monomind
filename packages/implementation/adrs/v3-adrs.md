...
- Migration effort from v2 to v1
...
**We will restructure v1 using Domain-Driven Design (DDD) principles with clear bounded contexts.**
...
- Current architecture assessment: docs/architecture/v1-assessment.md
...
Need to choose default memory backend for v1.
...
**v1 will support Node.js 20+ only. Deno support removed.**
