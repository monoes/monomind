...
The Quality Engineering (QE) domain provides comprehensive automated testing, quality assessment, and continuous validation capabilities for Monobrain v1. It is implemented as the `agentic-qe` plugin with 51 specialized QE agents organized across 12 Domain-Driven Design bounded contexts.
...
| QE Context            | v1 Domain    | Relationship      | Description                       |
| --------------------- | ------------ | ----------------- | --------------------------------- |
...
| security-compliance   | Security     | Conformist        | QE adapts to v1 security          |
...
All QE data is stored under the `aqe/v1/` namespace prefix:

| Namespace                      | Purpose                          | Vector Dim | HNSW Config   |
| ------------------------------ | -------------------------------- | ---------- | ------------- |
| `aqe/v1/test-patterns`         | Learned test generation patterns | 384        | M=16, efC=200 |
| `aqe/v1/coverage-data`         | Coverage analysis results        | 384        | M=12, efC=150 |
| `aqe/v1/defect-patterns`       | Defect intelligence data         | 384        | M=16, efC=200 |
| `aqe/v1/code-knowledge`        | Code knowledge graph             | 384        | M=24, efC=300 |
| `aqe/v1/security-findings`     | Security scan results            | 384        | M=16, efC=200 |
| `aqe/v1/contracts`             | API contract definitions         | 384        | M=12, efC=150 |
| `aqe/v1/visual-baselines`      | Visual regression baselines      | 768        | M=32, efC=400 |
| `aqe/v1/chaos-experiments`     | Chaos experiment data            | 384        | M=12, efC=150 |
| `aqe/v1/learning-trajectories` | ReasoningBank trajectories       | 384        | M=16, efC=200 |
