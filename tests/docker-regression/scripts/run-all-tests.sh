#!/bin/bash
# Monobrain Deep Regression Test Suite - Main Runner
...
LOG_DIR="${MONOBRAIN_LOG_DIR:-/app/logs}"
...
echo -e "${CYAN}╔════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     MONOBRAIN DEEP REGRESSION TEST SUITE                     ║${NC}"
...
cat > "$REPORT_FILE" << EOF
{
  "testSuite": "monobrain-deep-regression",
  "version": "3.0.0",
...
# ============================================================================
# TEST CATEGORY 11: V1 PACKAGE UNIT TESTS
# ============================================================================
echo ""
echo -e "${CYAN}▶ CATEGORY 11: V1 PACKAGE UNIT TESTS${NC}"

if bash "${SCRIPT_DIR}/run-unit-tests.sh"; then
    record_result "V1 Unit Tests" "passed" "0" ""
else
    record_result "V1 Unit Tests" "failed" "0" ""
fi
...
MONOBRAIN DEEP REGRESSION TEST SUMMARY
========================================
Date: $(date)
Version: 3.0.0
