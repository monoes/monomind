...
import type { UnusedExportInfo, DuplicationInfo } from '../../../packages/@monomind/monograph/src/lsp/hover.ts';
...
describe('buildHover', () => {
  ...
  it('prioritizes unused export over duplication on same line', () => {
    const exports: UnusedExportInfo[] = [{
      exportName: 'myFn', line: 5, col: 1, referenceCount: 2,
    }];
    const dups: DuplicationInfo[] = [{
      line: 5, col: 1, groupSize: 2, instanceCount: 2, similarityScore: 0.8,
    }];
