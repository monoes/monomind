...
- [2026-06-14 04:30] bffbaaf4 — fix(server): honour ?dir= query param in POST /api/loops/stop; handler used server-level projectDir for all stop requests, ignoring the ?dir= the client sends from stopLoopInProject() in Global Loops view — cross-project loop stopping always wrote .stop to the wrong directory