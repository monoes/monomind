...
Wait for the analyzer to return. Select the top-ranked improvement that has not been done.
...
Wait for the coder to return. Capture the changed file list and summary.
