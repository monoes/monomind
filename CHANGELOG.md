...
- **The Runtime tab left out budget exhaustion, agent-fatal, loadout mismatches, session crashes and context-limit restarts.** The runtime emits the first three as status events, not audit events, and the rest were not on the list.
