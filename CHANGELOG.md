...
- **`router.cjs`'s hardcoded agent table no longer selects agents.** Most of its slugs were not registry agents; it now only supplies skill keyword matches to the prompt hook.
