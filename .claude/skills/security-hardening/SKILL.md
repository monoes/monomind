...
description: "Complete security architecture hardening for monomind. Addresses critical CVEs (CVE-1, CVE-2, CVE-3) and implements secure-by-default patterns. Use for security-first implementation."
triggers:
...
Orchestrates comprehensive security hardening for monomind, addressing critical vulnerabilities and establishing security-first development practices using specialized v1 security agents.
