...
description: "CLI modernization and hooks system enhancement for monomind. Implements interactive prompts, command decomposition, enhanced hooks integration, and intelligent workflow automation."
triggers:
  - modernize CLI
  - CLI refactor
  - interactive CLI
...
Modernizes monomind CLI with interactive prompts, intelligent command decomposition, enhanced hooks integration, performance optimization, and comprehensive workflow automation capabilities.
...
- `core-implementation` - Core domain integration
- `memory-unification` - Memory-backed command caching
- `swarm-coordination` - CLI swarm management integration
- `performance-optimization` - CLI performance monitoring
