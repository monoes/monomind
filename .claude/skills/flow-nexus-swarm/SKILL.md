...
Flow Nexus swarms integrate seamlessly with Monobrain hooks:

```bash
# Pre-task coordination setup
npx monobrain@alpha hooks pre-task --description "Initialize swarm"

# Post-task metrics export
npx monobrain@alpha hooks post-task --task-id "swarm-execution"
```
...
- **Documentation**: https://github.com/nokhodian/flow-nexus
- **Issues**: https://github.com/nokhodian/flow-nexus/issues

---

**Remember**: Flow Nexus provides cloud-based orchestration infrastructure. For local execution and coordination, use the core `monobrain` MCP server alongside Flow Nexus for maximum flexibility.
