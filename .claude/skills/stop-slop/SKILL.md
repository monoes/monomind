...
<!-- Pattern adapted from stop-slop by Hardik Pandya (hvpandya.com) — ported for monomind -->
...
Load on demand when doing a full pass:
- [references/phrases.md](references/phrases.md) — banned phrases by category
