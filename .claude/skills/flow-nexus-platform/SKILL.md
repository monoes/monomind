...
mcp__flow-nexus__execution_stream_subscribe({
  stream_type: "monobrain-swarm", // claude-code, monobrain-swarm, monobrain-hive-mind, github-integration
...
mcp__flow-nexus__execution_files_list({
  stream_id: "stream_id",
  created_by: "monobrain", // claude-code, monobrain, git-clone, user
...
- **GitHub Issues**: https://github.com/nokhodian/flow-nexus/issues
