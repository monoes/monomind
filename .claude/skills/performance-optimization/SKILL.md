...
triggers:
  ...
  - benchmark monomind
  - Flash Attention target
  - validate performance targets
  - startup time too slow
  - SONA adaptation slow
  - performance suite
---
...
Validates and optimizes monomind to achieve industry-leading performance through Flash Attention, AgentDB HNSW indexing, and comprehensive system optimization with continuous benchmarking.
...
- `agentic-integration` - Performance integration architecture
- `memory-unification` - Memory performance optimization
- `swarm-coordination` - Swarm performance coordination
- `security-hardening` - Secure performance patterns
