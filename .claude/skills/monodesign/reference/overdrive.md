...
2. **Ask the user for clarification before proceeding.** to present these directions and get the user's pick before writing any code. Explain trade-offs (browser support, performance cost, complexity).
