...
If a `DESIGN.md` already exists, **do not silently overwrite it**. Show the user the existing file and Ask the user for clarification before proceeding. whether to refresh, overwrite, or merge.
