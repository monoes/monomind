...
1. **Model Cache**: Enable with `MONOBRAIN_MODEL_CACHE_MB=512`
2. **Parallel Workers**: Enable with `MONOBRAIN_WORKER_PARALLEL=true`
3. **Warning Suppression**: Enable with `MONOBRAIN_SUPPRESS_WARNINGS=true`
