...
description: |
  Integration Architect for cross-package deduplication, dependency consolidation, and building monobrain as a specialized extension rather than parallel implementation of upstream libraries.
---
