...
capability:
  ...
  goal: Coordinate hierarchical swarm operations with strategic planning and worker delegation
  version: "1.0.0"
  expertise:
    - swarm coordination
  ...
  output_type: SwarmOrchestrationResult
  model_preference: opus
  termination: All delegated tasks completed and results aggregated by coordinator
---
