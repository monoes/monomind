Show the Monobrain token usage dashboard for the requested period.

Run this shell command immediately without asking for confirmation:

```bash
node "${CLAUDE_PROJECT_DIR:-/Users/morteza/Desktop/tools/monobrain}/.claude/helpers/token-tracker.cjs" report "${1:-today}"
```
