...
In `hooks_pre-command` ([`hooks-routing.ts:L187`](packages/@monomind/cli/src/mcp-tools/hooks-routing.ts#L187)), the evaluation flag `shouldProceed` is calculated deterministically as:
...
- **Persistent Routing Outcome Store**: Task and routing outcomes are persisted under `.monomind/routing-outcomes.json` ([`hooks-embedding.ts:L22`](packages/@monomind/cli/src/mcp-tools/hooks-embedding.ts#L22)) and appended to `.monomind/route-outcomes.jsonl`.
