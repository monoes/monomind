...
MonoFence AI categorizes security events into 9 primary threat classifications ([`packages/monofence-ai/src/domain/entities/threat.ts`](packages/monofence-ai/src/domain/entities/threat.ts#ThreatType)):
...
Single-turn scanners miss slow, multi-turn probing attacks. MonoFence AI maintains state across conversation turns using an escalation state machine ([`packages/monofence-ai/src/domain/services/context-tracker.ts`](packages/monofence-ai/src/domain/services/context-tracker.ts#ContextTracker)):
...
MonoFence AI scans post-generation output payloads before delivering them to users or tools ([`packages/monofence-ai/src/domain/services/output-scanner.ts`](packages/monofence-ai/src/domain/services/output-scanner.ts#scan)):
...
MonoFence AI reports real-time latency and threat metrics via the CLI and MCP tool surface ([`packages/@monomind/cli/src/mcp-tools/security-tools.ts`](packages/@monomind/cli/src/mcp-tools/security-tools.ts#securityTools)):
...
| Security Lifecycle Hooks | [`packages/monofence-ai/src/hooks/security-hook.ts → registerSecurityHooks`](packages/monofence-ai/src/hooks/security-hook.ts#registerSecurityHooks) |
| CLI MCP Security Tools | [`packages/@monomind/cli/src/mcp-tools/security-tools.ts → securityTools`](packages/@monomind/cli/src/mcp-tools/security-tools.ts#securityTools) |
