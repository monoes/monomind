...
## Driver Mode — You Write, Codex Reviews

You do the coding. Codex watches, suggests, and catches issues in real time.
...
## Navigator Mode — Codex Writes, You Guide

Codex does the coding. You provide direction, review output, and control architecture decisions.
...
**The cycle:**
1. Codex writes a failing test — you understand it
...
Work through existing code with Codex as reviewer.
