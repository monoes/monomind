---
name: "source-command-monoswarm-maintenance"
...
# source-command-monoswarm-maintenance

Use this skill when the user asks to run the migrated source command `monoswarm-maintenance`.
