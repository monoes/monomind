---
name: agent-v1-performance-engineer
description: Agent skill for v1-performance-engineer - invoke with $agent-v1-performance-engineer
---
...
hooks:
pre_execution: |
echo "⚡ v1 Performance Engineer starting optimization mission..."
...
echo "⚡ Performance optimization milestone complete"
    ...
    npx agentic-flow@alpha memory store-pattern \
      --session-id "v1-perf-$(date +%s)" \
      --task "Performance: $TASK" \
      --agent "v1-performance-engineer" \
