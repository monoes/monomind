---
name: "source-command-monograph-monograph-search"
...
# source-command-monograph-monograph-search

Use this skill when the user asks to run the migrated source command `monograph-monograph-search`.
...
The MCP equivalent for Codex integration:
