---
name: "source-command-monoswarm-examples"
...
# source-command-monoswarm-examples

Use this skill when the user asks to run the migrated source command `monoswarm-examples`.
