...
Tell Codex everything it needs to know upfront:
...
This keeps both you and Codex aligned on state.
...
| Never verifying Codex's code | Test frequently, review before committing |
...
Or just tell Codex at the start of the next session:
