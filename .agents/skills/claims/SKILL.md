...
### Check Claim
```bash
npx monobrain claims check --agent agent-123 --claim write
```

### Grant Claim
```bash
npx monobrain claims grant --agent agent-123 --claim write --scope "/src/**"
```

### Revoke Claim
```bash
npx monobrain claims revoke --agent agent-123 --claim write
```

### List Claims
```bash
npx monobrain claims list --agent agent-123
```
