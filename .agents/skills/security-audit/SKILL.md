...
```bash
npx @monobrain/cli security scan --depth full
```

**Example:**
```bash
npx @monobrain/cli security scan --depth full --output security-report.json
```
...
**Example:**
```bash
npx @monobrain/cli security scan --check input-validation --path ./src/api
```
...
```bash
npx @monobrain/cli security audit --report
```

**Example:**
```bash
npx @monobrain/cli security audit --report --format markdown --output SECURITY.md
```
...
```bash
npx @monobrain/cli security threats --analyze
```
