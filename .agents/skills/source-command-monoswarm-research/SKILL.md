---
name: "source-command-monoswarm-research"
...
# source-command-monoswarm-research

Use this skill when the user asks to run the migrated source command `monoswarm-research`.
