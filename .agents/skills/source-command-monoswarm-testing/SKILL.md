---
name: "source-command-monoswarm-testing"
...
# source-command-monoswarm-testing

Use this skill when the user asks to run the migrated source command `monoswarm-testing`.
