---
name: "source-command-monograph-monograph-stats"
description: "Show knowledge graph statistics — node counts by type, edge type breakdown, and top concepts by importance score"
---

# source-command-monograph-monograph-stats

Use this skill when the user asks to run the migrated source command `monograph-monograph-stats`.
