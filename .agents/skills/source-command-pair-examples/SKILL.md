...
Real-world scenarios with actual Codex patterns — no fictional CLI.
...
Codex implements. Review each piece:
...
Codex asks targeted questions. You share relevant code sections.
...
**Red phase:** Codex writes failing tests. You read and understand each.

**Green phase:** You implement just enough to pass.

> "Tests passing. Now refactor the total calculation — it's too long."

Codex refactors. You verify tests still pass.
...
Codex reviews: "Looks good, but you're missing error handling on the database call. Add a try/catch."
