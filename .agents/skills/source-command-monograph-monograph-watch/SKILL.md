---
name: "source-command-monograph-monograph-watch"
...
# source-command-monograph-monograph-watch

Use this skill when the user asks to run the migrated source command `monograph-monograph-watch`.
...
# Watch with Codex semantic enrichment on each rebuild
