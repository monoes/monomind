---
name: "source-command-monoswarm-analysis"
...
# source-command-monoswarm-analysis

Use this skill when the user asks to run the migrated source command `monoswarm-analysis`.
