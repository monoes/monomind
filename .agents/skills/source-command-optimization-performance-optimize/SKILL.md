---
name: "source-command-optimization-performance-optimize"
...
# source-command-optimization-performance-optimize

Use this skill when the user asks to run the migrated source command `optimization-performance-optimize`.
