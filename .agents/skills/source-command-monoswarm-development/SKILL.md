---
name: "source-command-monoswarm-development"
...
# source-command-monoswarm-development

Use this skill when the user asks to run the migrated source command `monoswarm-development`.
