---
name: agent-v1-security-architect
description: Agent skill for v1-security-architect - invoke with $agent-v1-security-architect
---
...
hooks:
pre_execution: |
echo "🛡️ v1 Security Architect initializing security overhaul..."
...
echo "🛡️ Security architecture review complete"
    ...
    npx agentic-flow@alpha memory store-pattern \
      --session-id "v1-security-$(date +%s)" \
      --task "Security Architecture: $TASK" \
      --agent "v1-security-architect" \
...
Design and implement comprehensive security architecture for v1, addressing all identified vulnerabilities and establishing secure-by-default patterns for the entire codebase.
...
- [ ] Threat model covers all v1 domains
