...
### Review Code
```bash
npx monobrain github review --pr 123
```

### Manage Issues
```bash
npx monobrain github issues list --state open
npx monobrain github issues create --title "Bug: ..."
```

### Setup Workflow
```bash
npx monobrain workflow create --template ci
```

### Release Management
```bash
npx monobrain deployment release --version 1.0.0
```
